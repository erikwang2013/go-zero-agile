...
func adminCreateHandler(svcCtx *svc.ServiceContext, db *gorm.Gormdb) http.HandlerFunc {
...
func adminDeleteHandler(svcCtx *svc.ServiceContext, db *gorm.Gormdb) http.HandlerFunc {
    return func(w http.ResponseWriter, r *http.Request) {
...
func adminPutHandler(svcCtx *svc.ServiceContext, db *gorm.Gormdb) http.HandlerFunc {
    return func(w http.ResponseWriter, r *http.Request) {
...
func adminHandler(svcCtx *svc.ServiceContext, db *gorm.Gormdb) http.HandlerFunc {
    return func(w http.ResponseWriter, r *http.Request) {
