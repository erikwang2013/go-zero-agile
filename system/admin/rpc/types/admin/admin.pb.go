...
type AdminResponse struct {
	...
	// 软删除
	IsDelete uint32 `protobuf:"varint,7,opt,name=is_delete,json=isDelete,proto3" json:"is_delete,omitempty"`
	// 创建时间
...
func (x *AdminResponse) GetGender() uint32 {
	if x != nil {
		return x.Gender
	}
	return 0
...
func (x *AdminResponse) GetStatus() uint32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *AdminResponse) GetIsDelete() uint32 {
	if x != nil {
		return x.IsDelete
	}
	return 0
...
func (x *AdminResponse) GetCreateTime() string {
	if x != nil {
		return x.CreateTime
	}
	return ""
...
func (x *AdminResponse) GetUpdateTime() string {
	if x != nil {
		return x.UpdateTime
	}
	return ""
...
var file_admin_proto_rawDesc = []byte{
	...
	0x64, 0x6d, 0x69, 0x6e, 0x22, 0x1b, 0x0a, 0x09, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69,
	0x64, 0x22, 0xee, 0x01, 0x0a, 0x0d, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x67, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x12,
	...
	0x74, 0x75, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x69, 0x73, 0x5f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x69, 0x73, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	...
	0x6d, 0x65, 0x32, 0x3b, 0x0a, 0x05, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x12, 0x32, 0x0a, 0x08, 0x67,
	0x65, 0x74, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x12, 0x10, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e,
	0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x61, 0x64, 0x6d, 0x69,
	0x6e, 0x2e, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
...
var file_admin_proto_goTypes = []interface{}{
	(*IdRequest)(nil),     // 0: admin.IdRequest
	(*AdminResponse)(nil), // 1: admin.AdminResponse
}
var file_admin_proto_depIdxs = []int32{
	0, // 0: admin.Admin.getAdmin:input_type -> admin.IdRequest
	1, // 1: admin.Admin.getAdmin:output_type -> admin.AdminResponse
